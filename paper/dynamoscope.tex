...
\paragraph{Caveats and what would falsify this claim.}
\begin{itemize}
\item Capacity gap: RWM has 30K parameters vs.\ 12K for the flat
  baseline. Some of the advantage is capacity, not architecture.
  A matched-parameter flat baseline experiment is needed.
\item Periodic in-distribution is tied; the architecture does not
  uniformly win.
\item The router still operates supervised. Truly unsupervised
  regime discovery in this architecture remains unsolved.
