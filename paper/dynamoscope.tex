...
gradient is a tug-of-war the optimizer cannot win on a small model.
We expect the gap closes with larger models and longer training, or
with explicit gradient-surgery techniques (PCGrad), but we do not
claim this. We expose this negative result prominently as a
direction for future weighting-schedule research.
