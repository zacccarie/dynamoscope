...
would need either a different observable whose temporal autocorrelation
structure shifts more abruptly at $\mu=0$, or a regime classifier
trained from data rather than thresholded by hand. We flag both as
concrete next-experiments. The four falsified-hypotheses experiments
together provide rigorous evidence that the lag is not what a
casual reader might first assume.
