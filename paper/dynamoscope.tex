...
\item Contrastive descriptor pre-training to give the router a
  pre-trained discriminative space, perhaps from a separate phase
  of regime-classification on raw observables.
\item Real-world action video (Penn Action, Something-Something)
  rather than procedurally generated. This is the natural next step.
\end{itemize}
